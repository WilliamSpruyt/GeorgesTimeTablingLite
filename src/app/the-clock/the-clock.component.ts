...
export class TheClockComponent implements OnInit {
  ...
  constructor(private statservice: StatsService,
    ...
    private data: ScoreService,
    private st: SimpleTimer,
    private router: Router, private qs: TheQuestionsService,
  ...
  ngOnInit() {
    ...
    this.time.inPlay.subscribe(message => this.inPlay = message)
  ...
  timer0callback(): void {
    ...
    else if (this.score < this.testLength && this.inPlay) {
      this.counter0++;
      this.time.changeTime(this.counter0)
    }
  }
